...
LiquidCrystal_I2C lcd(0x27,16,2);        // 2 Si Le LCD ne fonctionne pas, alors mettre // sur la ligne précédente et enlever les // sur cette ligne
...
void loop()
{
  ...
  float verif_ampere1     = emon1.Irms;        // 1 creation de la variable "Ampères Moyen" (mesurable avec une pince ampèremétrique pour l'etalonnage))
  float verif_ampere2     = emon2.Irms;
  float verif_ampere3     = emon3.Irms;
 ...
 //--------------------------Etalonnage des volts et ampères sans LCD--------------------------------------
  ...
  Serial.print(" -A2: ");
  Serial.print(verif_ampere2);                    
  Serial.print(" -A3: ");
  Serial.print(verif_ampere3);                  
  Serial.print("   ");
